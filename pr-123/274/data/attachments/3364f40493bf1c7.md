...
- Name: payment-challenge.spec.ts >> Payment Challenge >> Verify that the "Єдині" challenge page contains "Допомогти проєкту" button with redirecting to the payment modal
