...
Call log:
  - waiting for locator('#basic_email')
...
- generic [ref=e1]:
  ...
  - menu [ref=e203]:
    - menuitem "Зареєструватися" [ref=e204] [cursor=pointer]:
      - generic [ref=e206]: Зареєструватися
    - menuitem "Увійти" [active] [ref=e207] [cursor=pointer]:
      - generic [ref=e209]: Увійти
```
