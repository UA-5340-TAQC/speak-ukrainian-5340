...
- Name: ui/profile-page.spec.ts >> Profile Page Tests >> TC-91: Verify that Edit Profile button is displayed and clickable
- Location: tests/ui/profile-page.spec.ts:60:3
...
Call log:
  - waiting for locator('div.ant-modal.modal-login[role="dialog"]') to be hidden
    5 × locator resolved to visible <div role="dialog" aria-modal="true" class="ant-modal css-13m256z modal-login ant-zoom-appear ant-zoom-appear-active ant-zoom">…</div>
    29 × locator resolved to visible <div role="dialog" aria-modal="true" class="ant-modal css-13m256z modal-login">…</div>
