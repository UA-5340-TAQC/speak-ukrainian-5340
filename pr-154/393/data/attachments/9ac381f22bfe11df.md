...
- Name: api/category-api.spec.ts >> Category API >> POST /category >> should create a new category
- Location: tests/api/category-api.spec.ts:54:5
...
```ts
  ...
  3   | import { CategoryBuilder } from '@/data';
  4   | import { CategoryResponseDto } from '@/api/dto';
  5   | 
