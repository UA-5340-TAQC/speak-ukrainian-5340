              ...
              - generic [ref=e211]:
                - generic [ref=e213]:
                  ...
                  - link "Logo" [ref=e216] [cursor=pointer]:
                    ...
                    - img "Logo" [ref=e217]
                - generic [ref=e218]:
                  - generic [ref=e219]: або
                  - generic [ref=e220]:
                    - generic [ref=e222]:
                      - generic "Емейл" [ref=e224]: "Емейл:"
                      - generic [ref=e228]:
                        - textbox "Емейл:" [ref=e229]:
                        ...
                        - generic [ref=e230]:
                          ...
                          - generic:
                            - img "check-circle":
                              - img
                    - generic [ref=e235]:
                      - generic "Пароль" [ref=e237]: "Пароль:"
                      - generic [ref=e241]:
                        - textbox "Пароль:" [ref=e242]:
                          - /placeholder: Введіть ваш пароль
                          - text: Qwerty@12345
                        - generic [ref=e243]:
                          - img "eye-invisible" [ref=e244] [cursor=pointer]:
                            - img [ref=e245]
                          - generic:
                            - img "check-circle":
                              - img
                  - button "Увійти" [active] [ref=e254] [cursor=pointer]:
                    - generic [ref=e255]: Увійти
              - link "Забули пароль?" [ref=e257] [cursor=pointer]:
                - /url: ""
```
