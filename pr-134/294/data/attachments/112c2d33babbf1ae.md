...
- Name: ui/message-manager.spec.ts >> TC-094 — Verify that clicking "Написати менеджеру" button shows the authentication modal for unauthorized users
- Location: tests/ui/message-manager.spec.ts:4:1
