...
- Name: ui/navigation-tests/header-navigation.spec.ts >> Header Navigation Tests >> TC-029: Verify that all navigation menu links redirect to the correct pages
- Location: tests/ui/navigation-tests/header-navigation.spec.ts:34:3
