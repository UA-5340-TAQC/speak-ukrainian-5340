    ...
    - generic [ref=e39]:
      ...
      - generic [ref=e59]:
        ...
        - main [ref=e136]:
          - generic [ref=e137]:
            - generic [ref=e138]:
              - generic [ref=e139]: "Сортувати:"
              - generic [ref=e140] [cursor=pointer]: за алфавітом
              - generic [ref=e141] [cursor=pointer]: за рейтингом
              - generic [ref=e142] [cursor=pointer]:
                - img "arrow-up" [ref=e143]:
                  - img [ref=e144]
                - img "arrow-down" [ref=e146]:
                  - img [ref=e147]
            - generic [ref=e149]:
              - generic [ref=e150] [cursor=pointer]:
                - generic [ref=e151]:
                  - radio "Layer 1"
                - img [ref=e154]:
                  - generic "Layer 1" [ref=e155]
              - generic [ref=e157] [cursor=pointer]:
                - generic [ref=e158]:
                  - radio "Layer 1" [checked]
                - img [ref=e161]:
                  - generic "Layer 1" [ref=e162]
          - generic [ref=e164]:
            - generic [ref=e165]: За критеріями пошуку гуртків не знайдено
            - generic [ref=e166]: Заохочуйте гуртки до викладання українською мовою та доєднання до платформи.
            - button "Заохотити гуртки" [ref=e167] [cursor=pointer]:
              - generic [ref=e168]: Заохотити гуртки
  - contentinfo [ref=e169]:
    - generic [ref=e170]:
      - link [ref=e171] [cursor=pointer]:
        - /url: ""
      - generic [ref=e174]:
        - generic [ref=e175]: Нам небайдуже майбутнє
        - generic [ref=e176]: дітей та української мови
      - generic [ref=e178]:
        ...
        - link:
          - /url: ""
      - generic [ref=e182]: ©2021-2022 Design by Qubstudio & Development by SoftServe
    - generic [ref=e183]:
      - generic [ref=e184]: Наші партнери
      - generic [ref=e185]:
        - link "soft_serve" [ref=e186] [cursor=pointer]:
          - /url: https://www.softserveinc.com/uk-ua
          - img "soft_serve" [ref=e187]
        - link "Mova_obyednue" [ref=e188] [cursor=pointer]:
          - /url: https://www.facebook.com/zakonpromovu5670
          - img "Mova_obyednue" [ref=e189]
        - link "EDERA" [ref=e190] [cursor=pointer]:
          - /url: https://www.ed-era.com
          - img "EDERA" [ref=e191]
        - link "e-mova" [ref=e192] [cursor=pointer]:
          - /url: https://emova.language-ua.online
          - img "e-mova" [ref=e193]
        - link "Kraina_FM" [ref=e194] [cursor=pointer]:
          - /url: https://krainafm.com.ua
          - img "Kraina_FM" [ref=e195]
        - link "ucf" [ref=e196] [cursor=pointer]:
          - /url: https://ucf.in.ua
          - img "ucf" [ref=e197]
        - link "prostir_svobodi" [ref=e198] [cursor=pointer]:
          - /url: https://prostirsvobody.org
          - img "prostir_svobodi" [ref=e199]
    - generic [ref=e200]:
      - generic [ref=e201]: Як допомогти проєкту?
      - generic [ref=e202]: Ініціатива потребує постійної фінансової підтримки, аби покривати щоденні витрати на роботу.
      - link "Допомогти проєкту" [ref=e203] [cursor=pointer]:
        - /url: https://secure.wayforpay.com/payment/s0f2891d77061
        - button "Допомогти проєкту" [ref=e204]:
          - generic [ref=e205]: Допомогти проєкту
```
