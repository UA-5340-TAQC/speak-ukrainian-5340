...
- Name: payment-challenge.spec.ts >> Payment Challenge >> Verify that the "Клуб української мови "Розмовляй"" challenge page contains "Допомогти проєкту" button with redirecting to the payment modal
