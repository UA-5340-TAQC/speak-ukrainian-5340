      ...
      - generic [ref=e53]:
        ...
        - complementary [ref=e118]:
          - generic [ref=e119]:
            ...
            - generic [ref=e139]:
              - text: "Вік аудиторії:"
              - generic [ref=e140]: від 0 до 16 років
            - generic [ref=e141]:
              - generic [ref=e142]: Зв’яжіться з гуртком
              - generic [ref=e143]:
                - link "https://agclub.com.ua/" [ref=e146] [cursor=pointer]:
                  - /url: https://agclub.com.ua/
                - generic [ref=e148]: "+380443337101"
            - paragraph [ref=e150]: Схожі гуртки у місті Київ
      - main [ref=e151]:
        - generic [ref=e152]:
          - generic [ref=e153]:
            - generic [ref=e155]:
              - generic [ref=e156]: Коментарі
              - button "Залишити коментар" [ref=e157] [cursor=pointer]:
                - generic [ref=e158]: Залишити коментар
            - generic [ref=e159]:
              - generic:
                - list:
                  - listitem:
                                    ...
                                    - radio "star star" [checked]:
                                      ...
                                      - generic:
                                        - img "star":
                                          - img
                          - generic:
                            - paragraph: Test Comment 19:05:50
                                    ...
                                    - radio "star star" [checked]:
                                      ...
                                      - generic:
                                        - img "star":
                                          - img
                          - generic:
                            - paragraph: Test Comment 19:05:13
                            - button "enter Відповісти":
                              - img "enter":
                                - img
                              - paragraph: Відповісти
                                    ...
                                    - radio "star star" [checked]:
                                      ...
                                      - generic:
                                        - img "star":
                                          - img
                          - generic:
                            - paragraph: Test Comment 19:04:55
                            - button "enter Відповісти":
                              - img "enter":
                                - img
                              - paragraph: Відповісти
                                    ...
                                    - radio "star star" [checked]:
                                      ...
                                      - generic:
                                        - img "star":
                                          - img
                          - generic:
                            - paragraph: Test Comment 18:43:32
                            - button "enter Відповісти":
                              - img "enter":
                                - img
                              - paragraph: Відповісти
                                    ...
                                    - radio "star star" [checked]:
                                      ...
                                      - generic:
                                        - img "star":
                                          - img
                          - generic:
                            - paragraph: Test Comment 18:37:31
                            - button "enter Відповісти":
                              - img "enter":
                                - img
                              - paragraph: Відповісти
          - button "Показати більше arrow-down" [ref=e166] [cursor=pointer]:
            - paragraph [ref=e167]: Показати більше
            - img "arrow-down" [ref=e168]:
              - img [ref=e169]
  - contentinfo [ref=e171]:
    - generic [ref=e172]:
      - link [ref=e173] [cursor=pointer]:
        - /url: ""
      - generic [ref=e176]:
        - generic [ref=e177]: Нам небайдуже майбутнє
        - generic [ref=e178]: дітей та української мови
      - generic [ref=e180]:
        ...
        - link:
          - /url: ""
      - generic [ref=e184]: ©2021-2022 Design by Qubstudio & Development by SoftServe
    - generic [ref=e185]:
      - generic [ref=e186]: Наші партнери
      - generic [ref=e187]:
        - link "soft_serve" [ref=e188] [cursor=pointer]:
          - /url: https://www.softserveinc.com/uk-ua
          - img "soft_serve" [ref=e189]
        - link "Mova_obyednue" [ref=e190] [cursor=pointer]:
          - /url: https://www.facebook.com/zakonpromovu5670
          - img "Mova_obyednue" [ref=e191]
        - link "EDERA" [ref=e192] [cursor=pointer]:
          - /url: https://www.ed-era.com
          - img "EDERA" [ref=e193]
        - link "e-mova" [ref=e194] [cursor=pointer]:
          - /url: https://emova.language-ua.online
          - img "e-mova" [ref=e195]
        - link "Kraina_FM" [ref=e196] [cursor=pointer]:
          - /url: https://krainafm.com.ua
          - img "Kraina_FM" [ref=e197]
        - link "ucf" [ref=e198] [cursor=pointer]:
          - /url: https://ucf.in.ua
          - img "ucf" [ref=e199]
        - link "prostir_svobodi" [ref=e200] [cursor=pointer]:
          - /url: https://prostirsvobody.org
          - img "prostir_svobodi" [ref=e201]
    - generic [ref=e202]:
      - generic [ref=e203]: Як допомогти проєкту?
      - generic [ref=e204]: Ініціатива потребує постійної фінансової підтримки, аби покривати щоденні витрати на роботу.
      - link "Допомогти проєкту" [ref=e205] [cursor=pointer]:
        - /url: https://secure.wayforpay.com/payment/s0f2891d77061
        - button "Допомогти проєкту" [ref=e206]:
          - generic [ref=e207]: Допомогти проєкту
```
